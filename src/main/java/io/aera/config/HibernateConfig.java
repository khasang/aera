...
public class HibernateConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        localSessionFactoryBean.setPackagesToScan("io.aera.entity");
    ...
    private Properties hibernateProperties() {
        ...
        properties.put("hibetnate.dialect", environment.getRequiredProperty("hibernate.dialect"));
        properties.put("hibernate.show_sql", environment.getRequiredProperty("hibernate.show_sql"));
        properties.put("hibernate.format_sql", environment.getRequiredProperty("hibernate.format_sql"));
        properties.put("hibetnate.hbm2ddl.auto", environment.getRequiredProperty("hibernate.hbm2ddl.auto"));
