...
public class StoryControllerIntegrationTest {
    ...
    public void addStoryTest(){
        ...
        for(int i=0; i<chaptersCounter; i++){
            ...
            assertEquals(receivedStory.getChapters().get(i).getGoldPrice().intValue(),
                    story.getChapters().get(i).getGoldPrice().intValue());
        }
    }
    ...
    private Story prefillStory(){
        ...
        chapter1.setGoldPrice(new BigDecimal(BigInteger.valueOf(new Random().nextInt(100))));

        Chapter chapter2 = new Chapter();
        chapter2.setName(RandomStringUtils.randomAlphabetic(10).toUpperCase());
        chapter2.setGoldPrice(new BigDecimal(BigInteger.valueOf(new Random().nextInt(100))));
